...
SIMAPP = ./app
HTTPS_GIT := https://github.com/noandrea/lottery.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=lottery \
		  -X github.com/cosmos/cosmos-sdk/version.AppName=lotteryd \
		  -X github.com/cosmos/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/cosmos/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X "github.com/cosmos/cosmos-sdk/version.BuildTags=$(build_tags_comma_sep)" \
		  -X github.com/tendermint/tendermint/version.TMCoreSemVer=$(TMVERSION) \
		  -X github.com/cosmos/cosmos-sdk/types.DefaultBondDenom=$(BOND_DENOM)
...
ifneq ($(shell git rev-parse --abbrev-ref HEAD),main)
	...
	git tag -s -a "$(APP_VERSION)" -m "Changelog: https://github.com/lottery-dao/lottery/blob/main/CHANGELOG.md"
